...
public class Training {
    ...
    public Training(String dateOfTraining, String infoShort, String Start, String End, String Trainer, Integer maxplayers, Integer CurrentPlayers, ArrayList<String> registered){
